...
DATABASE_URL = os.getenv(
    'DATABASE_URL', "mongodb+srv://******:******@cluster0.vexqcep.mongodb.net/?retryWrites=true&w=majority")
...
BTCPAY_STORE_ID = os.getenv(
    'BTCPAY_STORE_ID', '4sfUtKnNNDvXzKEsyNyy5nrPe6WF31KL**********')
BTCPAY_TOKEN = os.getenv(
    'BTCPAY_TOKEN', 'cf34fe5713d7e4988d871df0f0621**********')
BTCPAY_SERVER = os.getenv(
    'BTCPAY_SERVER', 'https://testnet.demo.btcpayserver.org')
